 ...
 */
final class Version20220525100635 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE episode CHANGE title title VARCHAR(255) NOT NULL, CHANGE season_id season_id_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE episode CHANGE title title VARCHAR(100) NOT NULL, CHANGE season_id_id season_id INT NOT NULL');
